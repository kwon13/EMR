...
"""
## Fine-Tuning base
deepspeed --num_gpus 2 flan-t5_finetuning.py \
    --model_max_length 2048 \
    --model_name_or_path "google/flan-t5-base" \
    --output_dir 'flan-t5-base_gsm8k_baseline' \
    --num_train_epochs 6 \
...
deepspeed --num_gpus 2 flan-t5_finetuning.py \
    --model_max_length 2048 \
    --model_name_or_path "sample-T5" \
    --output_dir 'flan-t5-large_gsm8k_baseline' \
    --num_train_epochs 3 \
...
deepspeed --num_gpus 2 flan-t5_finetuning.py \
    ...
    --output_dir 'flan-t5-small_gsm8k_baselines' \
    --num_train_epochs 6 \
...
deepspeed --num_gpus 2 flan-t5_finetuning.py \
    --model_max_length 2048 \
    --model_name_or_path "flan-t5-large-sat" \
    --output_dir "flan-t5-large-sat-aqua_baselines" \
    --num_train_epochs 4 \
    --per_device_train_batch_size 4 \
    --per_device_eval_batch_size 2 \
    --gradient_accumulation_steps 1 \
